      ...
      if ($_POST['signUp'] == "1") {
        ...
        if (isset($row)) {
          ...
          if ($hashedPassword == $row['password']) {
            ...
            if (isset($_POST['stayLoggedIn']) AND $_POST['stayLoggedIn'] == '1' OR $_POST['submit'] == 'Log In!') {
...
<?php include("header.php"); ?>
    ...
    <div class="container" id="homePageContainer">
      ...
      <form method="post" id="signUpForm">
        ...
        <p><strong>Sign Up</strong> if you are interested!</p>

        <div class="form-group">
        
          <input class="form-control" type="email" name="email" placeholder="You email">
      ...
      <form method="post" id="logInForm">
        ...
        <p><strong>Log In</strong> if you have an account!</p>
